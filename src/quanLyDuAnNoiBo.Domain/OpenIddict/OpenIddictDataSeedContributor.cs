...
namespace quanLyDuAnNoiBo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("quanLyDuAnNoiBo") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "quanLyDuAnNoiBo", DisplayName = "quanLyDuAnNoiBo API", Resources = { "quanLyDuAnNoiBo" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["quanLyDuAnNoiBo_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["quanLyDuAnNoiBo_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["quanLyDuAnNoiBo_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["quanLyDuAnNoiBo_Swagger:RootUrl"]?.TrimEnd('/');
